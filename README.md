...
- Για την εμβόλιμη εξεταστική του Ιουνίου και για την επαναληπτική εξέταση του Σεπτεμβρίου τα ζητούμενα και οι βαθμολογίες από τα 3 παραδοτέα ισχύουν ως έχουν. 
- Η προθεσμία παράδοσης και των 3 παραδοτέων είναι μια ημέρα πριν τη γραπτή εξέταση του μαθήματος.
- Μετά το πέρας της γραπτής εξέτασης του μαθήματος οι φοιτητές/τρίες οφείλουν να παρουσιάσουν το παιχνίδι τους στο εργαστήριο για να κατοχυρώσουν το βαθμό της ατομικής εργασίας
